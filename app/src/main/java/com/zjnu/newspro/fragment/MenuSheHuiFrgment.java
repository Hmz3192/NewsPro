...
public class MenuSheHuiFrgment extends BaseFragment {
    ...
    public View initView() {
        View view = View.inflate(mcontext, R.layout.fragment_shehui, null);
            ...
            public void onLoadMore() {
                pullToRefreshRV.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //模拟加载数据的情况
//                        offset = offset + 10;
//                        List<ArticleUserPojo.Article> dataNew = Model.getInstance().getDbManager().getArticleDao().getArticlesByKind("社会", String.valueOf(offset));
//                        data.addAll(dataNew);
...
//        pullToRefreshRV.onRefresh();
    ...
    private void getData() {
        final String url = Constant.SHEHUI;
                ...
                OkHttpUtils
                        ...
                        .execute(new StringCallback() {
                            ...
                            public void onResponse(String response, int id) {
                                ...
                                Log.i("Save--articleUser:---", articleUserPojo.toString());
                                //存入数据库
