...
public class MenuYingShiFragment extends BaseFragment {
    ...
    public View initView() {
        View view = View.inflate(mcontext, R.layout.fragment_yingshi, null);
...
//            while (data.size() <= 0) {
//
//                data = Model.getInstance().getDbManager().getArticleDao().getArticlesByKind("影视", String.valueOf(offset));
//            }
//        }
        //是否开启下拉刷新功能
            ...
            public void onLoadMore() {
                pullToRefreshRV.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //模拟加载数据的情况
//                        offset = offset + 10;
//                        List<ArticleUserPojo.Article> dataNew = Model.getInstance().getDbManager().getArticleDao().getArticlesByKind("影视", String.valueOf(offset));
//                        data.addAll(dataNew);
...
//        pullToRefreshRV.onRefresh();
    ...
    private void getData() {
        final String url = Constant.YINGSHI;
