...
public class MenuGuoJiFrgment extends BaseFragment {
    ...
    public View initView() {
        View view = View.inflate(mcontext, R.layout.fragment_guoji, null);
            ...
            public void onLoadMore() {
                pullToRefreshRV.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //模拟加载数据的情况
//                        offset = offset + 10;
//                        List<ArticleUserPojo.Article>  dataNew = Model.getInstance().getDbManager().getArticleDao().getArticlesByKind("国际", String.valueOf(offset));
//                        data.addAll(dataNew);
...
//        pullToRefreshRV.onRefresh();
    ...
    private void getData() {
        final String url = Constant.GUOJI;
